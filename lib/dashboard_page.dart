...
import 'health_map_page.dart';
import 'pcod_tracker_page.dart'; // Import the new PCOD Tracker Page
...
class _DashboardPageState extends State<DashboardPage> with SingleTickerProviderStateMixin {
  ...
  void _onTabTapped(int index) {
    ...
    } else if (index == 3) { // Schedule tab - PCOD Tracker
      _navigateToPCODTracker();
    }
  }
  ...
  void _navigateToPCODTracker() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PCODTrackerPage(
        user: widget.user,
        pcodData: _pcodData,
        onDataUpdate: _updatePCODData,
      )),
    );
  }
            ...
            BottomNavigationBarItem(
              icon: Container(
                ...
                decoration: _currentIndex == 1 
                    ...
                    : null,
                child: Icon(_customIcons['health']!, size: 18),
              ),
              label: 'Health',
            ),
